...
namespace TRADEMGEN {
  ...
  public:
    ...
    /**
     * Get the expected number of requests to be generated by the demand
    ...
    /**
     * Get the expected total number of requests for all the demand
     * streams.
     *
     * @return stdair::NbOfRequests_T Expected total number of events to be
     *   generated.
     */
     ...
     *
     * The maximum, for each progress display object, is set to
     * be the expected total number of events.
     *
     * @param stdair::ProgressDisplayMap_T& The (Boost) progress
     *   display objects to initialise.
     */
