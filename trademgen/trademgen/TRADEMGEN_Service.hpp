...
namespace TRADEMGEN {
  ...
  public:
    ...
    void addDemandStream (const stdair::DemandStreamKey_T&,
                          ...
                          const stdair::RandomSeed_T&,
                          const stdair::RandomSeed_T&) const;

    /** Get the total number of requests to be generated by the demand
        stream which corresponds to the given key. */
    const stdair::NbOfRequests_T& getTotalNumberOfRequestsToBeGenerated (const stdair::DemandStreamKey_T&) const;
    ...
    /** Generate a request with the demand stream which corresponds to
        the given key. */
    stdair::BookingRequestPtr_T generateNextRequest (const stdair::DemandStreamKey_T&) const;
