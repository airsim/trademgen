...
const stdair::DateGenerationMethod K_TRADEMGEN_DEFAULT_DATE_GENERATION_METHOD (stdair::DateGenerationMethod::POI_PRO);

/** Default date-time request generation method name: 'P' for Poisson Process. */
const char K_TRADEMGEN_DEFAULT_DATE_GENERATION_METHOD_CHAR ('P');
...
int readConfiguration (int argc, char* argv[], bool& ioIsBuiltin,
  ...
  config.add_options()
    ...
    ("dategeneration,G",
     boost::program_options::value< char >(&lDateGenerationMethodChar)->default_value(K_TRADEMGEN_DEFAULT_DATE_GENERATION_METHOD_CHAR),
...
void generateDemand (TRADEMGEN::TRADEMGEN_Service& ioTrademgenService,
                     ...
                     stdair::DateGenerationMethod& iDateGenerationMethod) {
  ...
  for (NbOfRuns_T runIdx = 1; runIdx <= iNbOfRuns; ++runIdx) {
    ...
    */
    const stdair::Count_T& lActualNbOfEventsToBeGenerated =
      ioTrademgenService.generateFirstRequests(iDateGenerationMethod);
...
int main (int argc, char* argv[]) {
  ...
  stdair::DateGenerationMethod lDateGenerationMethod (K_TRADEMGEN_DEFAULT_DATE_GENERATION_METHOD);
  ...
  generateDemand (trademgenService, lOutputFilename, lNbOfRuns, lDateGenerationMethod);
